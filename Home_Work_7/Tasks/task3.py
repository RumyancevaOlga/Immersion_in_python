...
if __name__ == '__main__':
    names = r'G:\Домашнее задание GeekBrains\Immersion_in_python\Home_Work_7\Doc\file_1.txt'
    numbers = r'G:\Домашнее задание GeekBrains\Immersion_in_python\Home_Work_7\Doc\file_4.txt'
    mult(names, numbers)
